function timePSD_ipad_MVT_highgrid(name)
...
for i = 1:n_data_ch
    data = ecog.contact_pair(i).raw_ecog_signal;%remontaged_ecog_signal;
...
saveas(hf1,[filename(1:11),'fig_spc_ecg_mf2_',filename(20:end)],'fig');
print(hf1,[filename(1:11),'pdf_spc_ecg_mf2_',filename(20:end-4)],'-dpdf');

%saveas(hf1,[filename(1:11),'fig_spc_ecg_mov_',filename(20:end-4)],'fig');
%print(hf1,[filename(1:11),'pdf_spc_ecg_mov_',filename(20:end-4)],'-dpdf');
