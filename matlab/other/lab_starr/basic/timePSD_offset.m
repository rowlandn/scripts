...
if ~isempty(emg_files) || ~isempty(accel_files)
    usedata = menu('Previously saved offset times were retrieved!','Use them','Do not use them');
...
%         epoch_ts = ecog.active_time;
        ...
        if typedata~=3
            ...
            move_onset = DetectEMG_offset(time,move,epoch_ts);
...
if n_data_ch==6  
    if typedata==1
        save([outputname '_timePSD_emg_off.mat'],'A2plot', 'C_trans','faxis','taxis','move_onset','emg_i','emg_ch_names','M1_ch');
    %     save([outputname '_timePSD_emg.mat'],'Smag_mean','faxis','taxis','move_onset','emg_i','emg_ch_names');
        saveas(hf1,[outputname '_timePSD_emg_off'],'fig');
        saveas(hf2,[outputname '_timeCOH_emg_off'],'fig');
    elseif typedata==2
        save([outputname '_timePSD_accel_off_off.mat'],'A2plot','C_trans','faxis','taxis','move_onset','M1_ch');
    %     save([outputname '_timePSD_accel.mat'],'Smag_mean','faxis','taxis','move_onset');
        saveas(hf1,[outputname '_timePSD_accel_off'],'fig');
        saveas(hf2,[outputname '_timeCOH_accel_off'],'fig');
    else
        save([outputname '_timePSD_button_off.mat'],'A2plot','C_trans','faxis','taxis','move_onset','M1_ch');
        saveas(hf1,[outputname '_timePSD_button_off'],'fig');
        saveas(hf2,[outputname '_timeCOH_button_off'],'fig');
    end
else
        if typedata==1
        save([outputname '_timePSD_emg_off.mat'],'A2plot', 'faxis','taxis','move_onset','emg_i','emg_ch_names','M1_ch');
    %     save([outputname '_timePSD_emg.mat'],'Smag_mean','faxis','taxis','move_onset','emg_i','emg_ch_names');
        saveas(hf1,[outputname '_timePSD_emg_off'],'fig');
%         saveas(hf2,[outputname '_timeCOH_emg'],'fig');
    elseif typedata==2
        save([outputname '_timePSD_accel_off.mat'],'A2plot','faxis','taxis','move_onset','M1_ch');
    %     save([outputname '_timePSD_accel.mat'],'Smag_mean','faxis','taxis','move_onset');
        saveas(hf1,[outputname '_timePSD_accel_off'],'fig');
%         saveas(hf2,[outputname '_timeCOH_accel'],'fig');
    else
        save([outputname '_timePSD_button_off.mat'],'A2plot','faxis','taxis','move_onset','M1_ch');
        saveas(hf1,[outputname '_timePSD_button_off'],'fig');
