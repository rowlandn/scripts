function troughtrigspectrogram()
% spiketrigecog()
% This m-file takes beta trough timestamps stored in a .mat, then
...
%% spike timestamps
[fn, pn] = uigetfile('_beta_trough_data.mat', 'Select trough time file ');
filename = strrep(fn,'.mat','');
