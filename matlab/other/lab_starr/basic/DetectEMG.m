function emg_onset = DetectEMG(time, emg, epoch)
...
EMG_bl = [-2 -1];    % seconds before epoch timestamp used for baseline EMG activity
EMG_test = [-1 0]; % seconds around epoch timestamp to test EMG
