...
ecog_ch = input('Enter channel #s for good ECOG/LFP (format: [1 2 ...]): ');
evt_ch = input('Enter channel # for ECOG event voltage, otherwise leave blank: ');
emg_ch = input('Enter channel #s for desired EMG, otherwise leave blank (format: [1 2 ...]): ');
...
save( [outputname(1:end-4) ecog_channel_append '.mat'], 'ecog','n_ecog');
