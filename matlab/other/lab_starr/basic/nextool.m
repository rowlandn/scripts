% Rory L. Michaelis
% 2003.11.19 Major Revision
% 2002.08.19 began, 2002.08.26, 2002.12.08, 2003.07.02, 2003.10.09   
% 
% SCRIPT for joining pre-existing NEX Data File (*.nex) ...
% (COMING SOON: BATCH MODE for everything)
% ...with optionally another *.nex file of any complexity
% ...with optionally a *.nex file containing MOVEMENT EVENTS WRONGLY STORED as NEURON TIMESTAMPS (from Offline Sorter)
...
% ...with optionally CogentLog EVENTS & INTERVALS (currently totally hard-coded structure)
% ...with optionally a CogentLog keystroke AS MARKERS (coming soon)
%
...
if isempty(findobj('Tag','NexGUI')) % If NOT USING GUI
    ...
    merge_continuous = 1; % Load the *.MAT file containing continuous channels ???
