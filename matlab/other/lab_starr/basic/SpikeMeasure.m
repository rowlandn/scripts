function spk = SpikeMeasure( spk_wf, fs, fname, unitname, show, meta)
% spk = SpikeMeasure( spk_wf, fs, fname, unitname, show, meta )
...
%	meta - optional flag to write EMF file for each plot (default=false)
%
% Outputs:
...
if show
	...
	text(ax(2),ysc(1),['n=' num2str(spk.n) ],...
	...
	if meta
		...
		meta_name = [name '.' unitname '.wfmes.emf'];
