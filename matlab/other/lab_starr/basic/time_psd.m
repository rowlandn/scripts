...
if typedata==1
    save([outputname '_timePSD_emg.mat'],'Smag_mean','C_trans','faxis','taxis','move_onset','emg_i','emg_ch_names');
...
elseif typedata==2
    save([outputname '_timePSD_accel.mat'],'Smag_mean','C_trans','faxis','taxis','move_onset');
%     save([outputname '_timePSD_accel.mat'],'Smag_mean','faxis','taxis','move_onset');
    ...
    save([outputname '_timePSD_button.mat'],'Smag_mean','C_trans','faxis','taxis','move_onset');
