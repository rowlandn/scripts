function [n, ts_left, ts_right] = nex_int(filename, varname, verbose)
% nex_int(filename, varname, verbose): Read interval variable from a .nex file
%
...
%	verbose - optional to suppress verbose output
% OUTPUT:
