...
% Need to limit rest and active data to those freq range of interest (typically 4Hz-100Hz)
    ...
    [c1 i1] = max(rest_data);%finds max value of rest data and that value's index position
    allfreq(1,1,i)=freq(i1);%puts freq corresponding to max value into allfreq matrix
